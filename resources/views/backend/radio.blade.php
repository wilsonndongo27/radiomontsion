...
<div class="col-12">
    <div class="box">
        <div class="box-header headerpage">
            <div class="col-lg-8">
                <h3 class="box-title">Liste des Flux Radios</h3>
            </div>
            <div class="col-md-4">
                <i class="fa fa-plus-circle addbtn" id="newradio"></i>
            </div>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item statusForm" href="javascript:void()"
                                                data-id="{{$item->id}}"
                                                data-message="Le status de cette Radio sera mis à jour!"
                                                data-type="warning"
                                                data-url="{{ route ('status-radio')}}"
                                                data-token="{{csrf_token()}}">
                                                <i class="fa fa-ban"></i> Activer/Désactiver</a>
                                            <a class="dropdown-item" href="javascript:void()" id="updateradio"
                                                data-id="{{ $item->id }}"
                                                data-title="{{ $item->title }}"
                                                data-description="{{ $item->description }}"
                                                data-flux="{{ $item->flux }}"
                                            ...
                                            <a class="dropdown-item deleteForm" 
                                                ...
                                                data-id="{{$item->id}}"
                                                data-message="Cette Radio sera supprimer!"
                                                data-type="warning"
                                                data-url="{{ route ('delete-radio')}}"
                                                data-token="{{csrf_token()}}">
                    ...
                    @else
                        <tr >
                            <td colspan="7" class="text-primary text-center" >
                                <p class="emptylist">Aucune Radio enregistré pour l'instant!</p>
                            </td>
                        </tr>
                    @endif
                </tbody>
    ...
    <!-- modale ajouter une radio -->
    <div id="AddRadioModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header row">
                    <img class="col-lg-2 logoform" src="{{asset('images/logomini.jpeg')}}"/>
                    <h4 class="col-lg-7 modal-title">Ajouter une Radio</h4>
                    <button type="button" class="col-lg-2 close" data-dismiss="modal">&times;</button>
                </div>
                <form class="createform" lpformnum="1"  method="post" enctype="multipart/form-data" onsubmit="postSubmission()" action="{{ route ('create-radio')}}">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <div class="form-group label-floating">
                                    <input class="form-control"  name="title" required placeholder="titre du radio..." />
                                    <hr>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <p>Flux Radio</p>
                                <div class="form-group label-floating">
                                    <input type="text" class="form-control"  name="flux" required placeholder="Flux radio..." />
                                    <hr>
                                </div>
                            </div>
                        </div>
    ...
    <!-- modale modifier une radio -->
    <div id="updateRadioModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header row">
                    <img class="col-lg-2 logoform" src="{{asset('images/logomini.jpeg')}}"/>
                    <h4 class="col-lg-7 modal-title">Modifier cette Radio</h4>
                    <button type="button" class="col-lg-2 close" data-dismiss="modal">&times;</button>
                </div>
                <form class="updateform" lpformnum="1"  method="post" enctype="multipart/form-data" onsubmit="postSubmissionUpdate()" action="{{ route ('update-radio')}}">
                    <div class="modal-body">
                        @csrf
                        <div class="row">
                            <input type="hidden" name="id" id="radioid">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <p>Titre</p>
                                <div class="form-group label-floating">
                                    <input class="form-control"  name="title" id="radiotitle" placeholder="titre du radio..." />
                                    <hr>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                <p>Flux Radio</p>
                                <div class="form-group label-floating">
                                    <input type="text" class="form-control" id="radioflux"  name="flux" placeholder="Flux Radio..." />
                                    <hr>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-xs-12" >
                                <img src="" alt="" class="updateimage" id="radiocover">
                            </div>
                            <div class="col-lg-6 col-md-12 col-xs-12" >
                                <p>Logo de la Radio</p>
                                <div class="form-group label-floating" >
